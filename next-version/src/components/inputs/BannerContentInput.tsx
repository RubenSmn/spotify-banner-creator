  ...
  return (
    <div className="space-between mb-4 flex gap-2">
      <Tooltip label="Change between Icon and Text">
        <button
          className="inline-flex h-10 w-10 items-center justify-center rounded-md text-white dark:bg-cyan-400 dark:text-black"
      ...
      <input
        ...
        className="h-10 flex-1 rounded-md border bg-transparent px-4 text-black dark:border-gray-600 dark:text-white"
      />
      <DownloadButton />
    </div>
  );
